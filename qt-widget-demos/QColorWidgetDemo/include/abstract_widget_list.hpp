...
protected:
     ...
     */
    template<class T>
    T* widgetCast(int i) { return qobject_cast<T*>(widget(i)); }
...
private slots:
    void removeClicked(QWidget* w);
    void upClicked(QWidget* w);
    void downClicked(QWidget* w);

private:
    class Private;
    Private * const p;

    QWidget* createButton(QWidget* data, QSignalMapper*mapper,
