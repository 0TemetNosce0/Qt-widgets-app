...
void ColorDialog::setButtonMode(Button_Mode mode)
{
    ...
    case OkCancel:
        ...
        break;
    case OkApplyCancel:
        btns = QDialogButtonBox::Ok | QDialogButtonBox::Cancel | QDialogButtonBox::Apply | QDialogButtonBox::Reset;
        break;
    case Close:
...
void ColorDialog::update_widgets()
{
    ...
    QColor aphaColor = col;
    aphaColor.setAlpha(0);
    p->ui.slide_alpha->setFirstColor(aphaColor);
    aphaColor.setAlpha(255);
    p->ui.slide_alpha->setLastColor(aphaColor);
...
namespace {
QColor getScreenColor(const QPoint &global_pos)
{
#if (QT_VERSION < QT_VERSION_CHECK(5, 0, 0))
