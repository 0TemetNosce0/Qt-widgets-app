...
void TarCommandParserPrivate::parse()
{
    ...
    if(index_start < 0)
    {
        index_start = cmd.indexOf(".tgz ");
    }

    if(index_start < 0)
    {
        index_start  =cmd.indexOf(".tbz2 ");
    }

    if(index_start < 0)
    {
        index_start = cmd.indexOf(".tlz ");
    }

    if(index_start < 0)
    {
        index_start = cmd.indexOf(".tlzma ");
    }

    if(index_start < 0)
    {
        index_start = cmd.indexOf(".tlzo ");
    }

    if(index_start < 0)
    {
        index_start = cmd.indexOf(".txz ");
    }
