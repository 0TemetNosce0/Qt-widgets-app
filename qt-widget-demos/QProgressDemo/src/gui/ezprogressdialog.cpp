...
EZProgressDialog::EZProgressDialog(QWidget *parent,Qt::WindowFlags f) :
...
EZProgressDialog::EZProgressDialog(const QString &labelText,const QString &cancelButtonText,int value,int max,QWidget* parent,Qt::WindowFlags f)
	: EZ_BaseDialog(parent,"EZProgressDialog",ZBaseDialog::NO_MODAL,f)
#if QT_VERSION < 0x040000 || !INHERIT_PRIVATE
	,d_ptr(new EZProgressDialogPrivate)
#endif
