...
public:
    explicit EZProgressDialog(QWidget *parent = 0,Qt::WindowFlags f=0);
    EZProgressDialog(const QString& labelText,const QString& cancelButtonText="Cancel",int value=0,int max=100,QWidget* parent=0,Qt::WindowFlags f=0);
	~EZProgressDialog();
