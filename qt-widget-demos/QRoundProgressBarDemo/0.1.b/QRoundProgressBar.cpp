...
const double QRoundProgressBar::PositionLeft = 180;
const double QRoundProgressBar::PositionTop = 90;
const double QRoundProgressBar::PositionRight = 0;
const double QRoundProgressBar::PositionBottom = -90;
...
void QRoundProgressBar::setRange(double max, double min)
{
    m_min = min;
    m_max = max;
...
void QRoundProgressBar::drawText(QPainter &p, const QRectF &innerRect, double innerRadius, double value)
{
    ...
    p.drawText(textRect, Qt::AlignCenter, valueToText(m_value));
}
