...
QVariant TableModel::data(const QModelIndex &index, int role) const
{
    ...
    if (role == Qt::DisplayRole)
    {
        ...
        {
        case 0:
            return rows[index.row()].date;
        case 1:
            return rows[index.row()].author;
        case 2:
            return rows[index.row()].isbn;
        case 3:
            return rows[index.row()].price;
        }
    }
...
bool TableModel::lessThan(int column, int r1, int r2)
{
    ...
    {
    case 0:
        return rows[r1].date <= rows[r2].date;
    case 1:
        return rows[r1].author <= rows[r2].author;
    case 2:
        return rows[r1].isbn <= rows[r2].isbn;
    case 3:
        return rows[r1].price <= rows[r2].price;
    }
