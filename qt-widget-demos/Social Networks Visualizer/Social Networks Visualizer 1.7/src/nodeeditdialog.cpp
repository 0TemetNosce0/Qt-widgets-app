    ...
    : QDialog(parent)
{
    ...
    connect(ui.labelEdit, &QLineEdit::editingFinished, this, &NodeEditDialog::checkErrors);

    connect (ui.colorButton, &QToolButton::clicked, this, &NodeEditDialog::selectColor);
}
