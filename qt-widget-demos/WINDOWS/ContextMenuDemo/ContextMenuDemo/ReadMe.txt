========================================================================
    ACTIVE TEMPLATE LIBRARY : ContextMenuDemo Project Overview
========================================================================

AppWizard has created this ContextMenuDemo project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ContextMenuDemo.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ContextMenuDemo.vcxproj.filters
...
ContextMenuDemo.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ContextMenuDemo.h)
        GUID definitions                                (ContextMenuDemo_i.c)
        A type library                                  (ContextMenuDemo.tlb)
        Marshaling code                                 (ContextMenuDemo_p.c and dlldata.c)

ContextMenuDemo.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ContextMenuDemo.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ContextMenuDemo.pch and a precompiled types file named StdAfx.obj.
...
ContextMenuDemops.vcxproj
	...
	dlldata.c, ContextMenuDemo_i.c and ContextMenuDemo_p.c which are required
	to build the proxy/stub DLL.

ContextMenuDemops.vcxproj.filters
